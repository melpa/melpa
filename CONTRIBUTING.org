...
output.  Please help the MELPA community track AI assistance by providing a
[[https://docs.kernel.org/process/coding-assistants.html#attribution][Linux-style "Assisted-by" line]] under your files' Author line:
...
Where ~AGENT_NAME~ is the name of the product or framework (e.g. "Claude")
and ~MODEL_VERSION~ is the corresponding version (e.g. ~claude-opus-4-7~).
